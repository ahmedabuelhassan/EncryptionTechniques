 ...
 */
package com.abuelhassan.encryptiontechniques.CeaserTechnique;
...
public class Decryption extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(message);
        message.setBounds(30, 70, 520, 40);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/abuelhassan/encryptiontechniques/CeaserTechnique/Capture.PNG"))); // NOI18N
    ...
    private void decryptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_decryptActionPerformed
        try {
            ...
            if (!msg.isEmpty()) {
                ...
                int shiftKey = Integer.parseInt((String) key.getSelectedItem());
                int shift_clone = shiftKey;
                plainTextList.add("A");
                plainTextList.add("B");
                plainTextList.add("C");
                plainTextList.add("D");
                ...
                plainTextList.add("Z");
                for (int i = 0; i < 26; i++) {
                    if (shiftKey != plainTextList.size()) {
                        cipherTextList.add(i, plainTextList.get(shiftKey));
                        shiftKey++;
                    } else {
                        if (shiftKey == plainTextList.size()) {
                            for (int j = 0; j < shift_clone; j++) {
                                cipherTextList.add(plainTextList.get(j));
                            }
                            break;
                        }
                    }
                }
                String[] msgUpperCase = msg.toUpperCase().split("");
                for (int i = 0; i < msgUpperCase.length; i++) {
                    int originalIndex = plainTextList.indexOf(msgUpperCase[i]);
                    outputList.add(cipherTextList.get(originalIndex));
                }
                ...
                JOptionPane.showMessageDialog(null, "<html><body>your Original Message : <p style='width: 200px;'>" + cipherText + "</p> with Key: <p  style='width: 200px;'>" + shift_clone + "</p></body></html>", "cipher message", JOptionPane.INFORMATION_MESSAGE);
