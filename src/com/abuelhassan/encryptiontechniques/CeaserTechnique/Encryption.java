    ...
    private void encryptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_encryptActionPerformed
        try {
            ...
            if (!msg.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(null, "<html><body>your Cipher : <p style='width: 200px;'>" + cipherText + "</p> with Key: <p  style='width: 200px;'>" + shift_clone + "</p></body></html>", "cipher message", JOptionPane.INFORMATION_MESSAGE);
