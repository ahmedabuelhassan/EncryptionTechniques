    ...
    private void encryptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_encryptActionPerformed
        try {
            ...
            if (!check.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(null, "<html><body>Your Cipher : <p style='width: 200px;'>" + cipher_text + "</p> with key: <p style='width: 200px;'>" + key_text + "</p></body></html>", "cipher message", JOptionPane.INFORMATION_MESSAGE);
